...
<body>
    ...
    $teacher_id_ref = strip_tags(@$_POST['teacher_id_ref']);
    $date = date("Y-m-d");
    $code = rand();
    if ($submit) {
                        ...
                        if (preg_match("/[A-Z]/", $password)) {
                            if (preg_match("/[a-z]/", $password)) {
                                if (preg_match("/\W/", $password)) {
                                    ...
                                    $teacher_data_check = "SELECT teacher_id from teacher_data WHERE code='$teacher_id_ref'";
                                    $teacher_data_result = mysqli_query($conn, $teacher_data_check);
                                    while ($row = mysqli_fetch_array($teacher_data_result)) {
                                    ...
                                    if ($user_type == "teacher") {
                                        ...
                                        mysqli_query($conn, "INSERT INTO `student_data`(`student_id`, `student_name`, `student_email`,`teacher_id_ref`, `created_at`)
                                           VALUES (NULL, '$username','$email','$teacher_id', '$date')");
                                    }
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example3c" value="<?php echo $_GET["teacher_code"]; ?>" name="teacher_id_ref" class="form-control" />
